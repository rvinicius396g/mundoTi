...
<button data-toggle="collapse" data-target="#aula0">Aula 0 - BootStrap Introdução</button>
...
<button data-toggle="collapse" data-target="#aula1">Aula 1 - Conhecendo o BootStrap</button>
...
<button data-toggle="collapse" data-target="#aula2">Aula 2 - Preparando Nossa área de Trabalho</button>
...
<button data-toggle="collapse" data-target="#aula3">Aula 3 - Desenvolvendo um grid basico</button>
...
<button data-toggle="collapse" data-target="#aula5">Aula 5 - Criando a área da logo (Jumbotron) </button>
...
<button data-toggle="collapse" data-target="#aula6">Aula 6 - Trabalhando com col e row para criar a área dos artigos</button>
