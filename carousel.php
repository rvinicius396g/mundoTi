<div id="myCarousel" class="carousel slide carouselarea" data-ride="carousel">
	<!-- Indacadores -->
	...
	<!-- Envoltório dos Slides (imagens,título,subtítulo) -->
	<div class="carousel-inner" role="listbox">
		...
		<!-- Fim da primeia imagem do slide -->
	...
	</div><!--Fim do Envoltório dos Slides  -->
	...
	<!-- Fim dos Botões Direita e esquerda ! -->
</div>